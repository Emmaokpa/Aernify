...
import { PlusCircle, Edit, Trash2, ShieldOff, Loader2, XCircle, CheckCircle } from 'lucide-react';
...
export default function ManageGamesPage() {
  ...
  // This function cleanly decides what to render, avoiding invalid JSX structures.
  const renderContent = () => {
    if (isAuthLoading) {
      return (
    ...
    if (!isAuthenticated || !isAdmin) {
      return (
        <Alert variant="destructive" className="mt-6">
          ...
          <AlertDescription>
            You must be logged in as an administrator to manage games.
          </AlertDescription>
        </Alert>
      );
    }
    ...
    if (readError) {
      return (
        <Alert variant="destructive" className="mb-4">
          ...
          <AlertDescription>
            Could not load games. Check your connection and security rules.
            <br />
